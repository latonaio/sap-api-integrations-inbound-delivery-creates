...
import (
	sap_api_caller "sap-api-integrations-inbound-delivery-creates/SAP_API_Caller"
	sap_api_input_reader "sap-api-integrations-inbound-delivery-creates/SAP_API_Input_Reader"
	"sap-api-integrations-inbound-delivery-creates/config"
...
func main() {
	...
	caller.AsyncPostInboundDelivery(
		header,
		item,
		accepter,
	)
