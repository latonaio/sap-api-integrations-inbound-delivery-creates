...
type EC_MC struct {
	...
	InboundDelivery struct {
		InboundDelivery    string `json:"document_no"`
	...
	InboundDeliveryType string `json:"document_type"`
...
type SDC struct {
	...
	InboundDelivery struct {
		...
		} `json:"InboundDeliveryItem"`
	} `json:"InboundDelivery"`
	APISchema string   `json:"api_schema"`
	Accepter  []string `json:"accepter"`
	SQNumber  string   `json:"inbound_delivery"`
	Deleted   bool     `json:"deleted"`
}